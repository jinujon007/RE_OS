...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=False,
            server_default=sa.text("'Bengaluru'"),
        ),
        sa.Column(
            "state",
            sa.String(length=50),
            nullable=False,
            server_default=sa.text("'Karnataka'"),
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "total_projects", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "completed_projects",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.Column(
            "blocked_units", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        ...
        sa.Column(
            "delay_months", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=False,
            server_default=sa.text("'seed_estimated'"),
        ),
        sa.Column(
            "created_at", sa.DateTime(), nullable=False, server_default=sa.text("now()")
        ),
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "source", "source_listing_id", name="uq_listings_source_listing"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "records_scraped", sa.Integer(), nullable=False, server_default=sa.text("0")
        ),
        sa.Column(
            "records_inserted",
            sa.Integer(),
    ...
    op.create_table(
        ...
        sa.Column(
            "confidence", sa.Float(), nullable=False, server_default=sa.text("0.6")
        ),
        sa.Column(
            "source_count", sa.Integer(), nullable=False, server_default=sa.text("1")
        ),
        sa.Column(
            "last_confirmed",
            sa.Date(),
    ...
    op.create_table(
        ...
        sa.Column(
            "initiated_by", sa.Text(), nullable=False, server_default=sa.text("'ceo'")
        ),
    ...
    op.create_index(
        "idx_agent_runs_status", "agent_runs", ["status", "started_at"], unique=False
    )
    op.create_index(
        "idx_kaveri_market", "kaveri_registrations", ["micro_market_id"], unique=False
    )
    op.create_index(
        "idx_rera_projects_market", "rera_projects", ["micro_market_id"], unique=False
    )
    op.create_index(
        "idx_rera_projects_developer", "rera_projects", ["developer_id"], unique=False
    )
