...
def create_ceo_agent() -> Agent:
    return Agent(
        ...
        backstory=(
            ...
            "You frame every recommendation through an LLS land-acquisition lens: "
            "entry timing, parcel quality, approval risk, and downside protection. "
            "You explicitly evaluate JD/JV opportunities using clear criteria: "
            "stalled inventory overhang, developer debt/distress indicators, launch recency, "
            "execution credibility, legal/regulatory clarity, and margin headroom. "
            "You always convert market signal into PSF entry-point language with actionable "
            "bands, e.g., ideal acquire/hold/walk-away thresholds per micro-market. "
