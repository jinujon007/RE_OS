...
class TestGate62CompetitiveIntel:
    ...
    def test_absorption_leaders_have_absorption_pct_field(self):
        ...
        with patch("utils.db.get_engine") as mock_eng:
            ...
            mock_eng.return_value.connect.return_value.__enter__.return_value = mock_conn
            mock_conn.execute.return_value.fetchall.return_value = [
                ("Proj A", "Builder X", "A", "Devanahalli", 75.0, 100, 25, "2026-12-01"),
            ]
    ...
    def test_competitive_pulse_endpoint_returns_200_and_keys(self):
        ...
        with patch("intelligence.competitive_intel.CompetitiveIntelEngine") as MockEngine:
            ...
            mock_instance.pulse.return_value = {
                "new_launches": [], "psf_movers": [], "absorption_leaders": [],
                "generated_at": "2026-06-06T12:00:00", "market_filter": None, "days_window": 7,
            }
    ...
    def test_competitive_digest_under_1500_chars(self):
        ...
        pulse = {
            "new_launches": [{"project_name": "A", "developer_name": "B", "market": "Y", "total_units": 100}],
            "psf_movers": [{"project_name": "C", "developer_name": "D", "market": "H", "change_pct": 10.0, "direction": "UP"}],
            "absorption_leaders": [{"project_name": "E", "developer_name": "F", "market": "D", "absorption_pct": 80.0}],
        }
