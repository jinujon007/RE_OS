...
class TestCompetitiveDigest:
    def _sample_pulse(self, empty=False):
        ...
        return {
            "new_launches": [
                {"project_name": "Greenfield Towers", "developer_name": "Brigade", "market": "Yelahanka", "total_units": 200},
                {"project_name": "Lake View", "developer_name": "Prestige", "market": "Devanahalli", "total_units": 150},
            ],
            "psf_movers": [
                {"project_name": "Skyline", "developer_name": "Sobha", "market": "Hebbal", "change_pct": 12.5, "direction": "UP"},
            ],
            "absorption_leaders": [
                {"project_name": "Palm Grove", "developer_name": "Godrej", "market": "Yelahanka", "absorption_pct": 85.0},
            ],
        }
    ...
    def test_digest_truncation_is_unicode_safe(self):
        ...
        pulse["new_launches"] = [{
            "project_name": "A", "developer_name": "B",
            "market": "Y", "total_units": 999999,
        }] * 50
