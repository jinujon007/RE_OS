...
class TestReconstructHTML:
    def test_html_contains_rera_id(self):
        ...
        rec = {"project_name": "Test", "developer_name": "Dev", "total_units": 100,
               "completion_date": "2025-12-31", "rera_registration_no": "RERA/TEST/001"}
    ...
    def test_html_varies_with_seed(self):
        ...
        from data.training.rera_label import _reconstruct_html
        rec = {"project_name": "Test", "developer_name": "Dev", "total_units": 50,
               "completion_date": "2026-06-01", "rera_registration_no": "RERA/002"}
...
class TestBuildCompletion:
    def test_completion_fields_match(self):
        ...
        rec = {"project_name": "P1", "developer_name": "Brigade", "total_units": 200,
               "completion_date": "2026-03-31", "rera_registration_no": "RERA/003"}
...
class TestStratifiedSplit:
    ...
    def test_multi_developer_stratification(self):
        ...
        from data.training.rera_label import _stratified_split
        records = (
            [{"developer_name": "Brigade", "rera_registration_no": f"B/{i}"} for i in range(20)]
            + [{"developer_name": "Prestige", "rera_registration_no": f"P/{i}"} for i in range(15)]
            + [{"developer_name": "Sobha", "rera_registration_no": f"S/{i}"} for i in range(8)]
        )
