...
def test_a2_kaveri_deed_scout_parses_fixtures():
    ...
    for fpath in txt_files:
        ...
        assert result == [], (
            f"TXT not supported for EC Form 15, expected [], got {result}"
        )
    ...
    fixture_rows = [
        [
            "1",
            "Sy.No. 45/2, Jakkur Village, Yelahanka Hobli, 2400 Sq.Ft",
            "15-05-2026",
            ...
            None,
            None,
            "DOC NO: YEL-1-12345-2026-01",
        ],
        [
            "2",
            "Sy.No. 101/1A, Allalasandra Village, 3200 Sq.Ft",
            "10-04-2026",
            ...
            None,
            None,
            "DOC NO: YEL-2-67890-2026-02",
        ],
        [
            "3",
            "Sy.No. 88/3, Venkatala Village, 1800 Sq.Ft",
            "01-03-2026",
            ...
            None,
            None,
            "DOC NO: YEL-3-11111-2026-03",
        ],
    ]
    records = _parse_ec_form15_rows(fixture_rows)
    assert len(records) >= 3, (
        f"Expected ≥3 records from fixture rows, got {len(records)}"
    )
