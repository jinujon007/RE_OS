...
def test_gate63_demand_api_returns_config_absorption(_auth_env):
    ...
    for field in ("avg_listing_psf", "median_listing_psf",
                  "listing_trend_30d_pct", "absorption_pct",
                  "months_of_supply", "ticket_size_median_cr",
                  "days_on_market_p50", "avg_news_sentiment",
