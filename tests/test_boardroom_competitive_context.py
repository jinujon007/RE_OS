...
class TestBoardroomCompetitiveContext:
    def test_bd_head_task_includes_competitive_context(self):
        ...
        pkg = IntelPackage(survey_no="45/2", market="Yelahanka", collected_at="2026-06-06T00:00:00")
        ...
        with patch("intelligence.competitive_intel.CompetitiveIntelEngine") as MockEngine:
            ...
            mock_instance.absorption_leaders.return_value = [
                {"project_name": "Proj A", "developer_name": "Builder X", "absorption_pct": 85.0},
            ]
            mock_instance.new_launches.return_value = [
                {"project_name": "Proj B", "developer_name": "Builder Y", "total_units": 200},
            ]
